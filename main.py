...
class KarnaughMapM2(Scene):
    def construct(self):
        ...
        self.wait()
        self.play(text_1.animate.become(MathTex(r"F = X_{1} \underline{\bar X_{2}} \lor X_{1} \underline{X_{2}}").move_to(ab_pos)))
        self.wait()
        self.play(text_1.animate.become(MathTex(r"F = X_{1} \underline{\bar X_{2}} \lor X_{1} \underline{X_{2}}").move_to(ab_pos)))
        self.wait()
        self.play(text_1.animate.become(MathTex(r"F = X_{1}(\bar X_{2} + X_{2})}").move_to(ab_pos)))
        self.wait()
        self.play(text_1.animate.become(MathTex(r"F = X_{1}").move_to(ab_pos)))
        self.wait()
